...

{
    ...
    "<p>Done at last. Sadly, I lost some progress on this website as I forgot to produce a backup, so hopefully I recovered much of what was here. I guess I am not very good at blogging though, as there were significant gaps in this blog anyways. Still, I learned much over the recent few months, devoting my studies to scalable and reactive web systems with the likes of Spring for instance. I have also been studying the performance implications of the designs of various low-level systems, delving into a massive rabbit hole on interrupts and scheduling, as well as studying the effects of increasing bandwidth on latency from queueing. In general, these last 4 months have been rather fun, new hardware too, which I always enjoy studying in great depth. In particular, we have seen Intel release both Arrow Lake and Battlemage, and while the former was plagued with memory access latency issues and poor caching, the latter appears very strong, and I hope to toy with one soon. Still, that's it for now.</p>" +
    "</div>",
